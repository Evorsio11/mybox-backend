...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleValidation(MethodArgumentNotValidException e) {
        ...
        ApiResponse<Void> response = ApiResponse.error(ErrorCode.VALIDATION_ERROR, details);
    ...
    public ResponseEntity<ApiResponse<Void>> handleMaxUploadSizeExceeded(MaxUploadSizeExceededException ex) {
        ...
        ApiResponse<Void> response = ApiResponse.error(ErrorCode.FILE_TOO_LARGE);
        return ResponseEntity.status(ErrorCode.FILE_TOO_LARGE.getStatus()).body(response);
    }
